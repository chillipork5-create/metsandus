import { Lisa2Row, Project } from '../types';

export const STORAGE_KEY = 'mets_projects_v2';

// FIX: localStorage throws in sandboxed iframes — wrap in try/catch
...
export function saveProjects(projects: Project[]) {
  try {
    ...
    // Silently fail in restricted environments (iframes, private browsing)
