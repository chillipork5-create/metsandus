        ...
        <div className="mb-8 avoid-break">
          ...
          <div className="grid grid-cols-2 gap-6 mb-4">
            <table className="w-full text-xs divide-y divide-slate-100"><tbody>
              ...
              <tr><td className="py-1.5 text-slate-500">Tegelik rinnaspindala:</td><td className="py-1.5 font-bold text-indigo-700">{lisa3EffG.toFixed(2)} m²/ha</td></tr>
            ...
            <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs space-y-2">
              ...
              <div className="p-2 bg-indigo-50 border border-indigo-200 rounded flex justify-between font-bold text-indigo-900"><span>Lisa 3 kahju:</span><span className="font-mono">{lisa3Total.toFixed(2)} €</span></div>
            </div>
          </div>
          {points.length >= 2 && (
