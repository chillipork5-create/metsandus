...
export default function Lisa3Panel({ project, onUpdate }: {
  ...
  const handleAddTree = () => {
    ...
    if (!d || !a) return;
    const rows = [...lisa3.rows, { id: generateId(), liik: treeData.liik, grupp: 1, diam: d, arv: a }];
          ...
          <section className="card p-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <select className="input-field w-full" value={lisa3.puuliik} onChange={e => commitField('puuliik', e.target.value)}>
              ...
              <div className="space-y-1">
                ...
                <input type="number" className="input-field w-full" value={vanusStr}
              ...
              <div className="space-y-1">
                ...
                <input type="number" className="input-field w-full" value={alammaarStr}
