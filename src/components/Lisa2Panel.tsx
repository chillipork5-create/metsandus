  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-end">
      ...
      <div className="flex flex-col">
        ...
        <input type="number" className="input-field" placeholder="5" value={data.arv}
          onChange={e => setData({ ...data, arv: e.target.value })}
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <section className="card">
          ...
          <Lisa2Table
            ...
            onRemove={id => onUpdate({ lisa2: { ...project.lisa2, rows: project.lisa2.rows.filter(r => r.id !== id) } })}
            onUpdateTotal={val => onUpdate({ lisa2: { ...project.lisa2, kahju: val } })}
          />
        </section>
      </div>
