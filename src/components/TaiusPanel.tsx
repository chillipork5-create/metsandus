      ...
      <section className="card p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end mb-6">
          <div className="space-y-1">
            ...
            <select className="input-field w-full" value={taius.species} onChange={e => commit('species', e.target.value)}>
          ...
          <div className="space-y-1">
            ...
            <input type="number" className="input-field w-full" value={heightStr}
