        ...
        <section className="card p-8">
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <select className="input-field w-full" value={kannu.species} onChange={e => commit('species', e.target.value)}>
            ...
            <div className="space-y-1">
              ...
              <input type="number" className="input-field w-full" value={dStumpStr}
        ...
        <section className="card p-8">
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <input type="number" className="input-field w-full" value={d13Str}
